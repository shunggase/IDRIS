...
<body>
<nav class="navbar navbar-expand-lg navbar-dark" style="background: rgba(2, 20, 48, 0.4); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); border-bottom: 1px solid rgba(255,255,255, 0.05);">
