...
<head>
    ...
    <style>
        /* 1. คอนเทนเนอร์ควบคุมวิดีโอให้อยู่กับที่เต็มหน้าจอ */
        .video-bg-container {
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
            height: 100vh;
            z-index: -100; /* ดันลงไปอยู่เลเยอร์ล่างสุดใต้เนื้อหาทั้งหมด */
            overflow: hidden;
        }

        /* 2. ตั้งค่าตัวไฟล์วิดีโอให้ขยายคลุมพื้นที่แบบไม่เสียสัดส่วน */
        .video-bg {
            width: 100%;
            height: 100%;
            object-fit: cover; /* ทำหน้าที่ขยายเต็มจอเหมือน background-size: cover */
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        /* 3. แผ่นสีดำโปร่งแสงทับวิดีโอ ช่วยขับให้เมนูและปุ่มบนหน้าเว็บเด่นชัดและอ่านง่าย */
        .video-overlay {
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
            height: 100%;
            background: rgba(0, 0, 0, 0.45); /* สีดำโปร่งแสง 45% ปรับเพิ่ม/ลดได้ตามต้องการ */
            z-index: -99;
        }

        /* 4. เคลียร์พื้นหลังหน้าจอหลักของบราวเซอร์ให้โปร่งแสง เพื่อให้มองเห็นวิดีโอด้านหลัง */
        body {
...
<body>
    <div class="video-bg-container">
        <!-- 💡 อย่าลืมเปลี่ยนชื่อไฟล์ตรง src="video.mp4" ให้ตรงกับชื่อไฟล์วิดีโอในโฟลเดอร์ของคุณครับ -->
        <video autoplay loop muted playsinline class="video-bg">
            <source src="IDRIS video bg.mp4" type="video/mp4">
            บราวเซอร์ของคุณไม่รองรับการแสดงผลวิดีโอนี้
        </video>
